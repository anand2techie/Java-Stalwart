...
public class CollectionImpl {
	...
	static void learnMapInsideMap() {
		...
		// Map<String,List<Long>> customerContactMap=new
		// TreeMap<String,List<Long>>(); e.g. storing customer id's with their
		// phone numbers
		// Map<String,Customer> customerIdWithCUstomerObjectMap=new
		// TreeMap<String,Customer>();
	...
	private static void printAvgMarksScoredByStudents(
		...
		while (studentIdSetIr.hasNext()) {
			...
			Map<String, Integer> subjectMarksMap = studentWithSubjectDetailsMap.get(studentId);// get
																								// method
																								// to
																								// use
																								// to
	...
	static void learnCollectionOfObjects() {
		 ...
		 * Collections.sort(customersList,new CustomerNameComparator()); //-
		 * sorting is not applicable for List of objects unless you do on your
		 * own
		 */
		...
		searchForAnAcccountBalanceInCustomersList(customersList, 10000);
	...
	private static void searchForAnAcccountBalanceInCustomersList(List<Customer> customersList, int i) {
		// TODO Auto-generated method stub

		Customer newCustomerObjForSearch = new Customer();
		newCustomerObjForSearch.setAccountBalance(100000);

		System.out.println(Collections.binarySearch(customersList, newCustomerObjForSearch));
	}
